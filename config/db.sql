...
ALTER TABLE tblLOCPANEL_rooms ADD CONSTRAINT [DF_tblLOCPANEL_rooms_panelmode] DEFAULT (('SINGLE')) FOR [panelmode];
GO

ALTER TABLE tblLOCPANEL_rooms ADD CONSTRAINT [DF_tblLOCPANEL_rooms_boardwidth] DEFAULT ((1280)) FOR [boardwidth];
GO
